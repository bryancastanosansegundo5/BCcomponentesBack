...
public class CarritoController {
    ...
    public CompatibilidadResponseDTO comprobarCompatibilidad(@RequestBody CompatibilidadRequestDTO request) {
        return compatibilidadService.comprobarCompatibilidad(request);
    }
    // @PostMapping("/comprobar")
    // public ResponseEntity<String> comprobarCompatibilidad(@RequestBody
    ...
    // " \"estado\": \"compatible\",\r\n" + //
    // " \"problemas\": [\r\n" + //
    // " \"Faltan componentes esenciales como RAM, gráfica y fuente de
    // alimentación.\"\r\n" + //
    // " ],\r\n" + //
    // " \"sugerencias\": [23, 24, 27, 58, 21]\r\n" + //
    // "}\r\n" + //
    // "";
