...
public class DataInitializer {
    ...
    public CommandLineRunner initDatosUsuarioRol(
        ...
        return args -> {
            ...
            usuarioService.crearUsuarioSiNoExiste("admin@tienda.com", "12345678", "Admin", "ADMIN");
            usuarioService.crearUsuarioSiNoExiste("empleado@tienda.com", "12345678", "Empleado", "EMPLEADO");
