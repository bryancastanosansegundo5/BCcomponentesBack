...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    // Esta clase configura el canal de comunicación en tiempo real entre el
    // servidor y el frontend.
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/stock-alert") // 🔌 Define el endpoint de conexión WebSocket accesible en /stock-alert
                .setAllowedOrigins(corsOrigin) // 🌐 Permite conexiones desde cualquier dominio (se puede restringir por
                                               // seguridad)
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        // 📤 Activa un broker simple en memoria que usará rutas que empiecen por
        // /avisos para enviar mensajes a los clientes

        registry.setApplicationDestinationPrefixes("/app");
        // 📥 Define el prefijo que los clientes deben usar al enviar mensajes al
        // servidor (entrada)
    }
}
