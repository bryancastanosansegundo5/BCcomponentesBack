...
public List<OpcionMenuDTO> getOpcionesGestionPorUsuario(Long usuarioId) {
    ...
    public void insertarOpcionesPorDefecto() {
        ...
        opcionMenuRepository.save(new OpcionMenuVO("Descuentos", "/admin/gestion-descuentos", rolAdmin, "LATERAL"));
        opcionMenuRepository.save(new OpcionMenuVO("Logs de acceso", "/admin/logs", rolAdmin, "LATERAL"));
